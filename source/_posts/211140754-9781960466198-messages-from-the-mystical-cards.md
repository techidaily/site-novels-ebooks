  ...
  <div class="flex flex-col">
    ...
    >
      ...
      >
        <img
          ...
          src="https://img-001-ebook.techidaily.com/12f34f64e833af5155cd03b0d83f2b67b0211770c8b352bdcd67758de5a70811.jpg"
          alt=""
          width="312"
          height="500"
        />
      ...
      >
        ...
        <div class="flex flex-col px-4 md:px-8">
          ...
          <div class="flex-1">
            <strong>ISBN</strong>:<span class="px-2">9781960466198</span>
          </div>
          <div class="flex-1">
            <strong>Title</strong>:<span class="px-2"
              >Messages from the Mystical Cards</span
            >
          </div>
          <div class="flex-1">
    ...
    <div class="book-description flex-1 py-6 px-4 sm:p-6 md:py-10 md:px-8">
      <div class="book-description-main">
        <div accordion-content="" id="description">
          <p>
            The book contains 52 messages in the cards, which were received by
            the author with the help of channeling from The Creation Entities,
            in order to award a message, hope, and help.
          </p>
          <p><br /></p>
          <p>You may receive a message by following either option below.</p>
          <p><br /></p>
          <p><strong>Option A - Choose a number:</strong></p>
          <p>
            The reader thinks of a question and a number between 1-52 and opens
            the book on the page corresponding to the message number and reads
            the message received. You may repeat this as many times as you like,
            for yourself or for others. The reader may receive a message from
            the cards in any way he chooses, according to his intuition.
          </p>
          <p><br /></p>
          <p><strong>Option B - Choose randomly:</strong></p>
          <p>
            The reader thinks of a question, opens the book randomly and reads
            the message received. It
          </p>
          <p>may be repeated as often as you like, for you or for others.</p>
          <p><br /></p>
          <p>
          ...
          <p>
            <strong
              >Messages from the Mystical Cards is book #4 in the Gali Lucy
    ...
    <div class="book-free-get flex-1 py-6 px-4 sm:p-6 md:py-10 md:px-8">
      ...
      <a
        ...
        href="https://www.ebooks.com/en-us/book/211140754/messages-from-the-mystical-cards/gali-lucy/"
        target="_blank"
