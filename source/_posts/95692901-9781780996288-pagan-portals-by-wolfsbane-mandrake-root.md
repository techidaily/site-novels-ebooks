  ...
  <div class="flex flex-col">
    ...
    >
      ...
      >
        <img
          ...
          src="https://img-001-ebook.techidaily.com/9e8654ac644266395e4789402dd94b9cadb32f07676390d6b02d367dcd1d6925.jpg"
          alt=""
          width="312"
          height="500"
        />
      ...
      >
        ...
        <div class="flex flex-col px-4 md:px-8">
          ...
          <div class="flex-1">
            <strong>ISBN</strong>:<span class="px-2">9781780996288</span>
          </div>
          <div class="flex-1">
            <strong>Title</strong>:<span class="px-2"
              >Pagan Portals - By Wolfsbane &amp; Mandrake Root</span
            >
          </div>
          <div class="flex-1">
    ...
    <div class="book-description flex-1 py-6 px-4 sm:p-6 md:py-10 md:px-8">
      <div class="book-description-main">
        <div accordion-content="" id="description">
          ...
          domestic medicine and magic. Needless to say, when utilising a toxic
          plant in magic, we are adding certain extra deadly or potent energies
          into the mix and it is inadvisable to start messing about with deadly
          poisons unless we’ve made a thorough study of the subject - and not
          just by glancing at a paragraph in a book on herbal preparations!
        </div>
      </div>
    </div>
    ...
    <div class="book-free-get flex-1 py-6 px-4 sm:p-6 md:py-10 md:px-8">
      ...
      <a
        ...
        href="https://www.ebooks.com/en-us/book/95692901/pagan-portals-by-wolfsbane-mandrake-root/melusine-draco/"
        target="_blank"
