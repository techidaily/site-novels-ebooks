...
<main id="book-container">
  <div class="flex flex-col">
    <div class="book-brief flex-1 py-6 px-4 sm:p-6 md:py-10 md:px-8">
      <!-- brief-->
      <div class="book-brief-main">Harold Puthoff, Russell Targ</div>
    </div>
    <div
    ...
    >
      ...
      >
        <img
          ...
          src="https://img-001-ebook.techidaily.com/839547a580a80877fea29b17eee515af23e184d6dd95933b67bb10af5a78dfe9.jpg"
          alt=""
          width="312"
          height="500"
        />
      ...
      >
        ...
        <div class="flex flex-col px-4 md:px-8">
          ...
          <div class="flex-1">
            <strong>ISBN</strong>:<span class="px-2">9781944529284</span>
          </div>
          <div class="flex-1">
            <strong>Title</strong>:<span class="px-2"
              >Psychic Research and Modern Physics</span
            >
          </div>
          <div class="flex-1">
            <strong>Author</strong>:<span class="px-2"
              >Harold Puthoff; Russell Targ</span
            >
          </div>
          <div class="flex-1">
    ...
    <div class="book-description flex-1 py-6 px-4 sm:p-6 md:py-10 md:px-8">
      <div class="book-description-main">
        <div accordion-content="" id="description">
          This essay, chapter 22 of Psychic Exploration, describes the
          application of concepts of modern physics to the study of psychic
          functioning. Included are a discussion of an example of a theoretical
          model of precognition that is testable and is compatible with
          contemporary physics, and descriptions of recent experiments using
          instruments that have exceptional sensitivity. The full volume of
    ...
    <div class="book-free-get flex-1 py-6 px-4 sm:p-6 md:py-10 md:px-8">
      ...
      <a
        ...
        href="https://www.ebooks.com/en-us/book/95812999/psychic-research-and-modern-physics/harold-puthoff/"
        target="_blank"
