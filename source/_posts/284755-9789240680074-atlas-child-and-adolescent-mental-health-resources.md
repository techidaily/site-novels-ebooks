  ...
  <div class="flex flex-col">
    ...
    >
      ...
      >
        <img
          ...
          src="https://img-001-ebook.techidaily.com/b95be67b221a66cd018373d077a0ed753b178cfdaab12a99425b77be5a2234e9.jpg"
          alt=""
          width="312"
          height="500"
        />
      ...
      >
        ...
        <div class="flex flex-col px-4 md:px-8">
          ...
          <div class="flex-1">
            <strong>ISBN</strong>:<span class="px-2">9789240680074</span>
          </div>
          <div class="flex-1">
            <strong>Title</strong>:<span class="px-2"
              >Atlas - child and adolescent mental health resources</span
            >
          </div>
          <div class="flex-1">
    ...
    <div class="book-description flex-1 py-6 px-4 sm:p-6 md:py-10 md:px-8">
      <div class="book-description-main">
        <div accordion-content="" id="description">
          The Child and Adolescent Mental Health Atlas project, like the other
          ATLAS projects, is a systematic attempt to collect information from
          countries on existing services and resources. The themes covered
          include: Rights of the child and adolescent, policy and programmes,
          information systems, need for services, service system gaps,
          integration of services, barriers to care, care providers, training
          for care, financing of care and availability and use of medication.
        </div>
      </div>
    </div>
    ...
    <div class="book-free-get flex-1 py-6 px-4 sm:p-6 md:py-10 md:px-8">
      ...
      <a
        ...
        href="https://www.ebooks.com/en-us/book/284755/atlas-child-and-adolescent-mental-health-resources/world-health-organization/"
        target="_blank"
