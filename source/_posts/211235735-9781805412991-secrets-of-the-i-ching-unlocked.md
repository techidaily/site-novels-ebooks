...
<main id="book-container">
  <div class="flex flex-col">
    <div class="book-brief flex-1 py-6 px-4 sm:p-6 md:py-10 md:px-8">
      <!-- brief-->
      <div class="book-brief-main">Kevin Cook</div>
    </div>
    <div
    ...
    >
      ...
      >
        <img
          ...
          src="https://img-001-ebook.techidaily.com/8447fb51cf268648b2dbbf94ce5acb6fb709296f5f2296be11560d15dccff725.jpg"
          alt=""
          width="312"
          height="500"
        />
      ...
      >
        ...
        <div class="flex flex-col px-4 md:px-8">
          <div class="flex-1">
            <strong>Publisher</strong>:<span class="px-2">Kevin Cook</span>
          </div>
          <div class="flex-1">
            <strong>Published</strong>:<span class="px-2">December 2023</span>
          </div>
          <div class="flex-1">
            <strong>ISBN</strong>:<span class="px-2">9781805412991</span>
          </div>
          <div class="flex-1">
            <strong>Title</strong>:<span class="px-2"
              >Secrets of the I Ching Unlocked</span
            >
          </div>
          <div class="flex-1">
            <strong>Author</strong>:<span class="px-2">Kevin Cook</span>
          </div>
          <div class="flex-1">
            <strong>Imprint</strong>:<span class="px-2">Kevin Cook</span>
          </div>
          <div class="flex-1">
        ...
        <div accordion-content="" id="description">
          <p>
            <span style="color: rgb(0, 0, 0)"
              >When Astrology failed him he turned to the I Ching for answers.
              After asking questions for twelve hours a day, every day for
              almost three years, the answers revealed themselves. The book
              contains over forty hexagram changes and will give a good
              understanding of the I Ching.</span
            >
          </p>
          <p><br /></p>
        </div>
    ...
    <div class="book-free-get flex-1 py-6 px-4 sm:p-6 md:py-10 md:px-8">
      ...
      <a
        ...
        href="https://www.ebooks.com/en-us/book/211235735/secrets-of-the-i-ching-unlocked/kevin-cook/"
        target="_blank"
