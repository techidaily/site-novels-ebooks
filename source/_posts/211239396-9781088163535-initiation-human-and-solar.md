...
<main id="book-container">
  <div class="flex flex-col">
    <div class="book-brief flex-1 py-6 px-4 sm:p-6 md:py-10 md:px-8">
      <!-- brief-->
      <div class="book-brief-main">Alice A. Bailey</div>
    </div>
    <div
    ...
    >
      ...
      >
        <img
          ...
          src="https://img-001-ebook.techidaily.com/87c95e0c38ae3f71e6e83ea3c06b65b0cecf0d5220309aa7460193e96f8a2801.jpg"
          alt=""
          width="312"
          height="500"
        />
        ...
        <div class="flex flex-col px-4 md:px-8">
          <div class="flex-1">
            <strong>Publisher</strong>:<span class="px-2"
              >Cornerstone Book Publishers</span
            >
          </div>
          <div class="flex-1">
          ...
          <div class="flex-1">
            <strong>ISBN</strong>:<span class="px-2">9781088163535</span>
          </div>
          <div class="flex-1">
            <strong>Title</strong>:<span class="px-2"
              >Initiation, Human and Solar</span
            >
          </div>
          <div class="flex-1">
            <strong>Author</strong>:<span class="px-2">Alice A. Bailey</span>
          </div>
          <div class="flex-1">
    ...
    <div class="book-description flex-1 py-6 px-4 sm:p-6 md:py-10 md:px-8">
      <div class="book-description-main">
        <div accordion-content="" id="description">
          <p>
            Inspired by the works of Madame Blavatsky, Alice A. Bailey, was a
            respected teacher in what she termed "Ageless Wisdom". This
            metaphysical classic is designed to lift the student to a higher
            state through the practice of initiation in all of its forms.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="book-free-get flex-1 py-6 px-4 sm:p-6 md:py-10 md:px-8">
      ...
      <a
        ...
        href="https://www.ebooks.com/en-us/book/211239396/initiation-human-and-solar/alice-a-bailey/"
        target="_blank"
